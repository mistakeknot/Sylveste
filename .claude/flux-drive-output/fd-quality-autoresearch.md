...
Reviewed against:
- `os/Skaffen/internal/tool/` — all existing tool files
- `os/Skaffen/internal/git/git.go`
- `os/Skaffen/internal/evidence/emitter.go`
- `os/Skaffen/internal/mutations/store.go`
- `os/Skaffen/internal/tui/status.go` and `app.go`
- `os/Skaffen/AGENTS.md` and `CLAUDE.md`
