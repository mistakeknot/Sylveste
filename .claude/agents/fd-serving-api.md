...
## Task Context
interfere is a Python MLX-LM inference server built as a Demarch/interverse plugin. It must expose an OpenAI-compatible API with request queuing and priority scheduling for local use on M5 Max hardware.
