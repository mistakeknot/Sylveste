...
**MCP server plugins** (intercache, interdeep, interfluence, interflux, interject, interkasten, interknow, interlab, interlens, interlock, intermap, intermix, intermux, interrank, intersearch, interserve, tldr-swinton, tuivision):
```bash
