...
Gitignored clones of external repos for inspiration and bootstrapping Sylveste components.
...
Always connect findings back to specific Sylveste components. Seed mappings:

| Research Repo | Primary Sylveste Target | What to Look For |
|---------------|----------------------|------------------|
...
Write findings to **`docs/research/`** in the relevant Sylveste subproject (not here in `research/`). Use this naming convention:
...
- **Relevance** — why it matters for the Sylveste target
