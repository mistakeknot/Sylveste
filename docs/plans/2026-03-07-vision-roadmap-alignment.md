...
**Action:** Extract the full P2 (Next) and P3 (Later) item lists from `docs/sylveste-roadmap.md` into a new `docs/backlog.md`. Include the category headers. Add a header noting this is the detailed inventory companion to the roadmap.

### Task 2: Restructure roadmap Next section
**File:** `docs/sylveste-roadmap.md`
...
- [x] `docs/sylveste-roadmap.md` Now section unchanged (3 frontier + detailed inventory)
- [x] `docs/sylveste-roadmap.md` Next section has 5 themes, not 100+ items
