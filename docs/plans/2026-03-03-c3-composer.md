...
```bash
cd /home/mk/projects/Sylveste/os/clavain/cmd/clavain-cli && go get gopkg.in/yaml.v3
```
...
Run: `cd /home/mk/projects/Sylveste/os/clavain/cmd/clavain-cli && go mod tidy && go build -o ../../bin/clavain-cli-go .`
...
Run: `cd /home/mk/projects/Sylveste/os/clavain/cmd/clavain-cli && go test -run TestLoad -v`
Expected: PASS for fleet and spec loading

Run: `cd /home/mk/projects/Sylveste/os/clavain/cmd/clavain-cli && go test -run TestMatchRole -v`
Expected: PASS for role matching

Run: `cd /home/mk/projects/Sylveste/os/clavain/cmd/clavain-cli && go test -run TestResolveModel -v`
Expected: PASS for model resolution (safety floors, calibration, fleet preferred)

Run: `cd /home/mk/projects/Sylveste/os/clavain/cmd/clavain-cli && go test -run TestCompose -v`
Expected: PASS for full compose plans

Run: `cd /home/mk/projects/Sylveste/os/clavain/cmd/clavain-cli && go test ./... -v`
...
Run: `bash /home/mk/projects/Sylveste/os/clavain/scripts/build-clavain-cli.sh`
Expected: Build succeeds

Run: `cd /home/mk/projects/Sylveste && bats os/clavain/tests/shell/test_compose.bats`
...
Run: `bash -n /home/mk/projects/Sylveste/os/clavain/scripts/lib-compose.sh && echo "OK"`
Expected: OK
...
Run: `bash -n /home/mk/projects/Sylveste/os/clavain/hooks/lib-sprint.sh && echo "OK"`
Expected: OK

Run: `cd /home/mk/projects/Sylveste && bats os/clavain/tests/shell/test_lib_sprint.bats`
...
Run: `cd /home/mk/projects/Sylveste/os/clavain/cmd/clavain-cli && go test ./... -v -count=1`
...
Run: `/home/mk/projects/Sylveste/os/clavain/bin/clavain-cli-go compose --stage=ship | jq .`
Expected: Valid JSON with agents, budget, warnings

Run: `/home/mk/projects/Sylveste/os/clavain/bin/clavain-cli-go compose --stage=build | jq .`
