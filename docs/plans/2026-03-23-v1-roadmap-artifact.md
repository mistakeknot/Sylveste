...
**Focus:** F9 (Sylveste-c44z) — Write `docs/roadmap-v1.md` with parallel track model

## Context

This plan covers the first deliverable of the Sylveste-enxv epic: a canonical roadmap document. The other children (F1-F8) are separate sprints. This session produces the artifact that guides all future v0.7→v1.0 work.
...
- Sylveste-enxv.2 → A:L1.5→L3 (routing, phase-cost wiring)
- Sylveste-0rgc → A:L3 + B:L2 (gate threshold calibration)
- Sylveste-py89 → B:L2 (bd doctor auto-run)
- Sylveste-enxv.3 → Cross-track validation (deletion-recovery)
- Sylveste-c44z → Meta (this deliverable)
...
Stage changes, commit with descriptive message, close Sylveste-c44z.
